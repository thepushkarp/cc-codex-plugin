...
>
> You might be interested in [an equivalent okugin for Gemini](https://github.com/thepushkarp/cc-gemini-plugin) though
...
|--------|--------|---------|-------------|
| `--model` | any model name | gpt-5.4 | Model to use |
